...
class _AuthenState extends State<Authen> {
  ...
  Container buttomLoin(BoxConstraints boxConstraints) {
    return Container(
        ...
        pressFunc: () {
          ...
          if ((user?.isEmpty ?? true) || (password?.isEmpty ?? true)) {
            ...
            MyDialog(context: context).normalDialog(
                title: 'Have spece ?', subTitle: 'Please fill every blank');
          } else {
            print('No Space');
            processCheckLoin();
          }
  ...
  Future<void> processCheckLoin() async {
    String path =
        'https://www.androidthai.in.th/egat/getUserWhereUserwittaya.php?isAdd=true&user=$user';
          ...
          if (password == userModel.password) {
            MyDialog(context: context).normalDialog(
                pressFunc: () async{
                  ...
                  preferences.setStringList('data',data).then((value) {Navigator.pushAndRemoveUntil(
                      context,
                      MaterialPageRoute(
